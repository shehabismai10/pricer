                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(bottom: 30.0.h),
                      child: CustomTextField(
                        textEditingController: password,visible: true,
                        hintText: 'Password',
                        validation: (p0) {
                      ...
                      return CustomButton(
                        onPressed: () {
                          if (formKey.currentState?.validate() == true) {
                            BlocProvider.of<AuthBloc>(context,listen: false).add(Register(email: email.text, password: password.text, name: name.text));
                          }
                        },
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('Already have an account?',style: regularTextStyle,),
                          TextButton(onPressed: (){
                            navigateAndReplace(context, const LoginPage());
                          }, child: Text('Login!',style: regularTextStyle.copyWith(color: Colors.deepPurple),)),
                        ],
                      ),
                    )
                  ],
